// BrowserWindow and shell will be available in the Electron main process context
import { URL } from 'url'
...
class GoogleOAuthService {
  ...
  async startOAuthFlow(mainWindow) {
    try {
      ...
      // Create auth window (BrowserWindow is available in Electron main process)
